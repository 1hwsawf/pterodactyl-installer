...
# download URLs
export PANEL_DL_URL="https://github.com/pterodactyl-china/panel/releases/download/v1.11.11.0/panel.tar.gz"
...
welcome() {
  ...
  output "https://github.com/1hwsawf/pterodactyl-installer"
  output ""
